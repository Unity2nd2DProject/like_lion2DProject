...
//public class PrincessScene1Controller_legacy : MonoBehaviour
//{
...
//    private List<ToggleButton_legacy> toggleButtonList;
...
//        ToggleButton_legacy.OnToggleChangeRequested += CheckScheduleMenu;
...
//        {
//            string panelName = i < maxToggleButtonNum / 2 ? "Panel1" : "Panel2";
//            ToggleButton_legacy tb = Instantiate(toggleButtonPrefab, scheduleMenu.transform.Find(panelName)).GetComponent<ToggleButton_legacy>();
